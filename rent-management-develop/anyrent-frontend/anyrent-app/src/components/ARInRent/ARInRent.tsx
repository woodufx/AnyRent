...
import InRentCard from "../../library/inRentCard/inRentCard";
import { IOrder } from "../../core/models/order.model";
import { getItem, getItems } from "../../core/store/itemsSlice";

export interface ARInRentProps {}

const ARInRent = (props: ARInRentProps) => {
    ...
    const getItemsListByOrders = async () => {
        try {
            const response: any = await DataService.getUserActiveOrders(user.id);
    ...
    return (
        <div className="ar-history">
            <p className="ar-history__title">
                ...
                <span className="ar-history__text">Товары в аренде</span>
            </p>
            ...
            <div className="ar-history__colums-wrapper">
                ...
                <div className="ar-history__colums-other">
                    ...
                    <p className="ar-history__colums-item">Время</p>
